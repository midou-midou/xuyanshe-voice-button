    ...
    return ( 
        <div className="panel-container annoPanel-container siteinfoZoomIn">
            <div className="site-info">
                ...
                <p className="site-inner site-important">特别感谢各位切片man <i className="fas fa-heart"></i> 以及各家录播组的支持</p>
                ...
                <p className="site-inner site-important">此项目链接：
                    <i className="fab fa-github"></i><a target="_blank" rel="noopener noreferrer" style={{textDecoration: 'underline',color: 'var(--link-blue)',fontWeight: 'bold'}} href="https://github.com/MIMONATCH/xuyanshe-voice-button">GitHub</a>
