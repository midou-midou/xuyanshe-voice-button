...
function Footer() {
    ...
    return ( 
        <div className="footer-container-panel">
            ...
            <div id="footer-powerby">
                <span id="footer-info">Power By <i className="fab fa-react playReact"></i> <a target="_blank" href="https://react.docschina.org/">React</a></span>
            </div>
            <div id="footer-beian">
